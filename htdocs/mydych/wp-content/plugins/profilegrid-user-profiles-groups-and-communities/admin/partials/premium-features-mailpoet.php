...
<div class="pg-promo-nav-container" id="tab2C">
  ...
  <a href="admin.php?page=pm_extensions" class="pg-upgrade-banner">        
            <div class="pg-upgrade-banner-title"><?php esc_html_e( 'Add members to MailPoet lists by upgrading to ProfileGrid Premium Bundle.', 'profilegrid-user-profiles-groups-and-communities' ); ?><span class="pg-banner-info-bt">More Info</span></div>
